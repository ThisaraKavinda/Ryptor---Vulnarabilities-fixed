                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="m-sm-4">
                                            ...
                                            <form action="adminGoogleRedirect" method="post">
                                                <div class="text-center mt-3">
                                                    <button type="submit" id="login-admin" class="btn btn-lg btn-info">Sign in with Google</button> 
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="m-sm-4">
                                            ...
                                            <form action="agentGoogleRedirect" method="post">
                                                <div class="text-center mt-3">
                                                    <button type="submit" id="login-agent-google" class="btn btn-lg btn-info">Sign in with Google</button> 
                                                </div>
                                            </form>
                                        </div>
                                    </div>
